  ...
  return (
      <main className='financiar'>
        ...
        <div className='introducaoFin'>
          ...
          <br></br>
          <p>O imóvel deve estar localizado no mesmo município, nos municípios limítrofes ou integrantes da mesma região metropolitana onde você mora a mais de um ano, ou onde você trabalha.</p>
          <br></br>
          <h1>INFORMAÇÕES GERAIS</h1>
          <br></br>
          <ul>
            <li>Necessários dados cadastrais atualizados: renda, endereço, documentos pessoais;</li>
            <li>Aprovação do cadastro de acordo com a política de crédito da empresa;</li>
            <li>Imóvel a ser financiado deverá estar regularizado e não ser objeto de litígio;</li>
            <li>Financiamento de até 80% do valor do imóvel;</li>
            <li>Entrada a ser negociada com o dono do imóvel.</li>
          </ul>
          <br></br>
          ...
          <ul>
            ...
            <li>Não ser titular de um financiamento no Sistema Brasileiro de Habitação (SFH);</li>
            <li>Não ter um imóvel na mesma cidade onde pretende financiar o novo imóvel;</li>
            <li>O novo imóvel não pode ter sido comprado ou quitado pelo vendedor usando o saldo do FGTS nos últimos 3 anos.</li>
          </ul>
          <br></br>
          ...
          <ol>
            ...
            <li>Retorne à sua instituição financeira, após aprovação da avaliação, e siga as orientações fornecidas para assinar e registrar o contrato. Com o contrato registrado, os recursos do FGTS serão liberados ao vendedor;</li>
            <li>Organize suas finanças, após o crédito aprovado, para pagar em dia todas parcelas do financiamento (que podem ser de até, no máximo, 30% da renda familiar bruta).</li>
          </ol>
          <br></br>
          ...
          <ul>
            ...
            <li>Clique em “selecionar instituição financeira”, escolha a que você decidiu e confirme;</li>
            <li>Clique em “meu FGTS”, “ver todas as suas contas”, e depois “ver extrato”;</li>
          ...
          <ul>
            ...
            <li>Clique em “habitação e moradia própria”e confirme a leitura do termo e aceite;</li>
            <li>Seleciona “Caixa Econômica Federal” e confirma seleção;</li>
